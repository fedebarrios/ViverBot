...
public class ManagerSeguimientos {
	protected static ManagerSeguimientos control;
	public ArrayList<SeguimientoAltura> seguimientos;
	
	private ManagerSeguimientos(){
		this.seguimientos = new ArrayList<SeguimientoAltura>();
	}
	
	public static ManagerSeguimientos getInstance(){
		if(control == null ){
			control = new ManagerSeguimientos();
		}
		return control;
	}
	...
	public void clear(){
		ManagerSeguimientos.control = null;
	}
}
