...
public class ControlSeguimientosTest {
	...
	public void controlSeguimientos(){
		...
		PlantaDTO planta1 = new PlantaDTO(1, 60, new UbicacionDTO(5,4), new Fecha(10, 10, 2017));
		PlantaDTO planta2 = new PlantaDTO(4, 59, new UbicacionDTO(4,4), new Fecha(10, 10, 2017));
		...
		PlantaDTO planta3 = new PlantaDTO(10, 11, new UbicacionDTO(4,59), new Fecha(10, 10, 2017));
