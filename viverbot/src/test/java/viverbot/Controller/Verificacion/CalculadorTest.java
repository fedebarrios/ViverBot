...
public class CalculadorTest {
	...
	public void CalculadorTest(){
		...
		assertEquals(16.0 , c.calcular(new RegistroHistorial(new Medicion(140.0,Magnitudes.ALTURA),50), 3, 124.0), 0);
		assertEquals(0.0 , c.calcular(new RegistroHistorial(new Medicion(140.0,Magnitudes.ALTURA),50), 3, 150.0), 0);
	} 
}
